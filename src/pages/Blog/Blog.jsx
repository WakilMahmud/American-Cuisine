	...
	return (
		<>
			<Pdf targetRef={ref} filename="code-example.pdf">
				{({ toPdf }) => (
					<div className="absolute right-1/2 md:right-1/4 top-18 md:top-32">
			...
			<div className="w-4/5 mx-auto py-16 text-justify" ref={ref}>
				...
				<div className="my-8 border rounded-lg p-4 bg-gray-50">
					...
					<p className="mb-4">
						Uncontrolled components are form elements that manage their own state internally, without relying on React to manage their value. The
						value of an uncontrolled component is controlled by the DOM, not by React. <br />
						<br />
						...
						more control over the state of your form elements, but they may require more code and may be less performant than uncontrolled components
						in some cases.
					</p>
				</div>
				...
				<div className="my-8 border rounded-lg p-4 bg-gray-50">
					...
					<p className="mb-4">
						...
						such as string, number, bool, and shape. Additionally, you can use the <strong>`isRequired`</strong> modifier to specify that certain
						props are required and must be passed to the component. React will issue a warning in the console if a prop is passed to the component
						that does not match its specified PropTypes validator, which can be useful for catching bugs and ensuring that your components receive the
						correct props.
					</p>
				</div>
				...
				<div className="my-8 border rounded-lg p-4 bg-gray-50">
					...
					<p className="mb-4">
						...
						<br /> Node.js provides low-level features for building high-performance, scalable applications using JavaScript, while Express.js
						provides a set of higher-level features and tools, such as routing and middleware, to make it easier to build web applications and APIs
				...
				<div className="my-8 border rounded-lg p-4 bg-gray-50">
					...
					<p className="mb-4">
						...
						hooks can help improve the reusability, abstraction, testability, and consistency of a React application. By abstracting away complex
						logic or state management into a custom hook, developers can make their code more reusable and maintainable, without having to repeat the
						same code in multiple components. <br />
						<br />
